...
class Car extends sound implements vehicle , fourwheeler
    {
     static int speed= 10;
	 int maxSpeed = 50;
	 int limit =40;
	 ...
	 void decreaseSpeed()
	    {
	        speed = speed - 10;
		     System.out.println("\n\t Now the Car is running at the Speed of " +speed+"  Km/h." );
		}
	 ...
	 public void start()
	     {
			 openDoor();
			 closeDoor();
		     System.out.println("\n \t Now the Car Started at the Initial Speed of 10 km/h");
		 }
	 public void turn()
	     { 
